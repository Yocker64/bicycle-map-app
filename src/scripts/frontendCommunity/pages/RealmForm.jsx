                ...
                {loading ? (
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex space-x-4">
                            <button
                                type="submit"
                                className="w-1/2 py-2 px-4 bg-black-600 text-white font-semibold rounded-md shadow flex items-center justify-center space-x-2 hover:bg-black-700 focus:outline-none focus:ring-2 focus:ring-black-500 focus:ring-offset-2"
                            >
                                {isEditing
                                    ?
                                    <>
