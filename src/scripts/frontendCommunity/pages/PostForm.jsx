        ...
        <form onSubmit={(e) => handleSubmit(e, false)}>
                ...
                postImages.map((image) => (
                  <div key={image.id} className="relative w-24 h-24 mr-4 mb-4">
                    ...
                    <button
                      ...
                      className="absolute top-0 right-0 w-6 h-6 flex items-center justify-center black-800 opacity-80 text-white rounded-full p-1 text-sm focus:outline-none"
                    >
                      x
                    </button>
                  </div>
          ...
          <div className="flex space-x-4 text-xs sm:text-sm">
            ...
            <button
              ...
              className="w-1/3 py-2 px-4 bg-black-600 text-gray-200 font-semibold rounded-md shadow flex items-center justify-center space-x-2 hover:bg-black-700 focus:outline-none focus:ring-2 focus:ring-black-500 focus:ring-offset-2"
            >
